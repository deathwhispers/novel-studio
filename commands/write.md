...
**每个 beat 写完即追加到章节文件**（`chapters/第N章-章节名.md`）—— 作者可随时打开该文件阅读进度、手动编辑修改（Writer 续写模式不覆盖手改内容）。

**segment 模式**：

```
✍️ 第 11 章 · beat-1 写完（约 320 字）：

[200-400 字正文]

---
📂 已写入 chapters/第011章-章节名.md（## beat-1 标题下追加）
💡 你可以直接在文件中修改、添加批注——下次续写不会覆盖
...
```
✍️ 第 11 章全部 beat 写完（约 2100 字）：

[整章正文（节拍间无视觉分隔，干净阅读）]

---
📂 已完整写入 chapters/第011章-章节名.md
💡 可在文件中直接通读全文、手动修订任何节拍
