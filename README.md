...
为了简化使用流程，我们将原有的 16 个技能合并为 7 个，并新增独立的 `novel-feedback`，形成当前 8 个核心技能：
...
| 新增 | **novel-feedback** | 读者反馈追踪、分析和调整验证 |
...
**百万字长篇建议范围**：
- 总章节数：约400-600章（按剧情密度调整）
- 分卷数：约10-15卷（根据主线阶段划分）
- 每卷章节数：25-60章（根据剧情复杂度浮动）
- 每卷字数：约6-12万字

> **注意**：以上数字为参考范围，**不是硬性指标**。实际卷章分配应服从剧情需要：高潮卷可适当增加章节数，过渡卷可适当减少。保持全书节奏平衡即可，不必强求每卷均匀。
