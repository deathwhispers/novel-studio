...
- [ ] **排版合规**（按 `references/web-novel-formatting.md`）：每句≤30字？每段≤3句？系统文字是否用【】包裹？对话是否一人一段？

**检测方法**：
- 全文搜索 AI 味关键词（见 `references/ai-flavor-checklist.md` 完整关键词列表）
...
- 排版违规（单句超 30 字、单段超 3 句、系统文字未用【】、对话未一人一段）→ 硬伤，`局部修复`
